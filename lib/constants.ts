...
export const INTEGRATION_CATEGORIES = [
  {
    ...
    desc: 'Voice calling & telephony providers',
    icon: 'phone',
  },
  {
    label: 'LLM',
    href: '/integrations#llm',
    desc: 'AI language model providers',
    icon: 'cpu',
  },
  {
    label: 'Speech to Text',
    href: '/integrations#stt',
    desc: 'Transcription & STT engines',
    icon: 'mic',
  },
  {
    label: 'Text to Speech',
    href: '/integrations#tts',
    desc: 'Voice synthesis & TTS providers',
    icon: 'speaker',
  },
  {
    label: 'Tools',
    href: '/integrations#tools',
    desc: 'CRM, support & productivity apps',
    icon: 'tools',
  },
] as const;
