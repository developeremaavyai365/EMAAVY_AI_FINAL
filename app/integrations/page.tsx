              ...
              {[
                {
                  ...
                  desc: 'Auto-create contacts, update deal stages, log call outcomes, and trigger CRM sequences — all from agent conversations.',
                },
                {
                  cat: 'Communication',
                  color: '#25D366',
                  tools: ['Slack', 'WhatsApp', 'Gmail', 'Zoom'],
                  desc: 'Send agent alerts, escalation messages, meeting invites, and personalized follow-ups across every channel.',
                },
                {
                  cat: 'Support & Success',
                  color: '#286EFA',
          ...
          <FadeSection>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8">
              {[
                ...
                { name: 'Slack',      badge: undefined },
                { name: 'WhatsApp',   badge: undefined },
                { name: 'Shopify',    badge: undefined },
                { name: 'Stripe',     badge: undefined },
                { name: 'Notion',     badge: undefined },
                { name: 'Zapier',     badge: '6K+ apps' },
                { name: 'Airtable',   badge: undefined },
                { name: 'Pipedrive',  badge: 'CRM' },
                { name: 'Zoho',       badge: 'CRM' },
                { name: 'Intercom',   badge: undefined },
                { name: 'Freshdesk',  badge: undefined },
                { name: 'Calendly',   badge: undefined },
                { name: 'Zoom',       badge: undefined },
