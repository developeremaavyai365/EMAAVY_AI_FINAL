...
const AGENTS = [
  {
    ...
    description: 'Runs BANT or MEDDIC qualification frameworks on every inbound prospect, scores them against your ICP, logs intent signals directly to your CRM, and books only meetings that are genuinely worth your team\'s calendar. No more reps wasting time on leads that were never going to close.',
    ...
    capabilities: ['BANT / MEDDIC frameworks', 'ICP scoring engine', 'CRM auto-logging', 'Calendar booking', 'Objection handling', 'Multi-language support'],
    callSim: [
  ...
  },
  {
    ...
    description: 'Tracks health scores across your entire book of business, identifies at-risk signals like reduced logins, declining usage, or missed milestones, and proactively calls those accounts before they escalate. Also handles QBR prep, NPS follow-ups, and upsell check-ins at full scale.',
    ...
    metrics: [
      ...
      { label: 'NPS improvement', val: '+22pts' },
      { label: 'Upsell conversion', val: '14%' },
    ],
    useCases: ['At-risk account intervention', 'QBR scheduling & prep', 'NPS follow-ups', 'Expansion revenue calls'],
    capabilities: ['Health score monitoring', 'Proactive outreach triggers', 'QBR preparation', 'NPS follow-up flows', 'Usage analytics sync', 'Upsell qualification'],
    callSim: [
