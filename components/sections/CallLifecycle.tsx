...
const STAGES = [
  ...
  },
  {
    ...
    transcript: null,
    tech: ['Connection confirmed via Vobiz', 'HD audio channel opened', 'Two-way audio established', 'Background noise filter on'],
  },
  {
    id: 'stt',
    index: 3,
  ...
  },
  {
    ...
    detail: 'The full system prompt, CRM context, call history, and live transcript are assembled into a context window and sent to your connected LLM with streaming enabled. First token arrives in 280ms.',
    metrics: [
      { label: 'Model', val: 'LLM' },
