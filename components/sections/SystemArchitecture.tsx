...
const LAYERS = [
  {
    ...
    chips: ['Vobiz', 'Exotel', 'Plivo', 'Twilio', 'WebRTC', 'BYOC SIP'],
    stat: { val: '<500ms', label: 'Median TTFB' },
    detail: 'Elastic carrier routing with automatic failover across Vobiz, Exotel, Plivo, and Twilio. Connect your existing numbers in seconds. If one carrier has an issue, the call switches over instantly — no drop, no delay.',
    flow: ['Call Triggered', 'Carrier Selected', 'Emaavy Edge', 'Agent Live'],
    flowColors: ['#6366f1', '#818cf8', '#a5b4fc', '#c7d2fe'],
    integrations: [
      { name: 'Vobiz', desc: "Emaavy's native telephony partner for India", href: '/integrations' },
      { name: 'Exotel', desc: "India's leading cloud telephony platform", href: '/integrations' },
      { name: 'Plivo', desc: 'High-volume voice API, India & global', href: '/integrations' },
      { name: 'Twilio', desc: 'Global carrier with strong India coverage', href: '/integrations' },
    ],
  },
  {
    id: 'llm',
    ...
    sublabel: 'Model Routing Layer',
    accent: '#0891b2',
    accentDim: '#0891b215',
    accentBorder: '#0891b230',
    chips: ['OpenAI', 'Google Gemini', 'Anthropic', 'Groq', 'Custom LLM', 'BYOM'],
    stat: { val: '<500ms', label: 'Median TTFB' },
    detail: 'Plug in your preferred LLM — OpenAI, Google Gemini, Anthropic, Groq, or your own model. Streaming tokens hit the voice pipeline before the model finishes generating, keeping every conversation feeling instant and natural.',
    flow: ['Prompt Built', 'LLM Selected', 'Response Streamed', 'Voice Ready'],
    flowColors: ['#0891b2', '#06b6d4', '#67e8f9', '#cffafe'],
    integrations: [
      { name: 'OpenAI', desc: 'GPT-4o with streaming support', href: '/integrations' },
      { name: 'Google Gemini', desc: 'Gemini models for multilingual conversations', href: '/integrations' },
      { name: 'Anthropic Claude', desc: 'Claude for nuanced, thoughtful responses', href: '/integrations' },
      { name: 'Custom LLM', desc: 'Bring your own model — any OpenAI-compatible endpoint', href: '/integrations' },
    ],
  },
  {
    id: 'workflow',
    ...
    sublabel: 'Visual Flow Builder',
    accent: '#7c3aed',
    accentDim: '#7c3aed15',
    accentBorder: '#7c3aed30',
    chips: ['Visual Builder', 'Conditions', 'Branching', 'Loops', 'Rollback', 'Versioning'],
    stat: { val: '99.98%', label: 'Execution success rate' },
    detail: 'Build your agent call flows visually — no code needed. Set conditions, branches, and fallback paths. Every flow is versioned so you can roll back with one click. Changes go live instantly without restarting anything.',
    flow: ['Lead Arrives', 'Flow Triggered', 'Conditions Met', 'Agent Calls'],
    flowColors: ['#7c3aed', '#8b5cf6', '#a78bfa', '#ddd6fe'],
    integrations: [
      { name: 'Visual Flow Builder', desc: 'Drag-and-drop campaign flow creation', href: '/signup' },
      { name: 'Conditional Logic', desc: 'Branch flows based on caller responses', href: '/signup' },
      { name: 'A/B Testing', desc: 'Test different scripts and flows side by side', href: '/signup' },
      { name: 'Webhooks', desc: 'Trigger flows from any external event', href: '/integrations' },
    ],
  },
  {
    id: 'crm',
    ...
    chips: ['Webhooks', 'Google Calendar', 'WhatsApp', 'REST', 'OAuth2', 'HubSpot (Soon)'],
    stat: { val: '38ms', label: 'Avg trigger latency' },
    detail: 'Mid-call tool calls fire webhooks, book calendar slots, and send WhatsApp follow-ups — all before the agent finishes speaking. OAuth2-secured connectors mean no custom backend needed. HubSpot and Salesforce sync coming soon.',
    flow: ['Tool Call', 'Auth Check', 'Webhook Fire', 'Calendar Book'],
    flowColors: ['#059669', '#10b981', '#34d399', '#a7f3d0'],
    integrations: [
      { name: 'Webhooks', desc: 'Send real-time event data to your backend or any third-party service', href: '/integrations' },
      { name: 'Google Calendar', desc: 'Book meetings mid-call instantly via Cal.com or Google Calendar', href: '/integrations' },
      { name: 'WhatsApp', desc: 'Send follow-up messages and notifications via MSG91 WhatsApp API', href: '/integrations' },
      { name: 'HubSpot', desc: 'CRM sync — coming soon', href: '/integrations' },
    ],
  },
  {
    id: 'observability',
    ...
    chips: ['Transcripts', 'Call Recordings', 'Live Dashboard', 'Metrics', 'Alerts', 'Replay'],
    stat: { val: '100%', label: 'Calls recorded & searchable' },
    detail: 'Every call is recorded, transcribed word-by-word, and logged to your dashboard the moment it ends. See what was said, how the call went, and what action was taken — all in one place. Get alerted instantly if something needs attention.',
    flow: ['Call Ends', 'Transcript Ready', 'Dashboard Updated', 'Alert Sent'],
    flowColors: ['#d97706', '#f59e0b', '#fbbf24', '#fef08a'],
    integrations: [
      { name: 'Call Transcripts', desc: 'Full word-level transcripts for every conversation', href: '/signup' },
      { name: 'Live Dashboard', desc: 'Monitor all active and completed calls in real time', href: '/signup' },
      { name: 'Webhook Alerts', desc: 'Get notified instantly when a call ends or a lead is booked', href: '/integrations' },
      { name: 'Call Recordings', desc: 'Replay any call with a full audio and transcript timeline', href: '/signup' },
    ],
  },
];
